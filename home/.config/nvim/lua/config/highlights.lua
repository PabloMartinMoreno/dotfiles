...
local function aplicar()
  ...
  vim.api.nvim_set_hl(0, "RenderMarkdownInfo", { fg = p.teal }) -- info
  vim.api.nvim_set_hl(0, "RenderMarkdownCalloutNota", { fg = p.violeta }) -- nota
  vim.api.nvim_set_hl(0, "RenderMarkdownCalloutResumen", { fg = p.azul }) -- resumen
  ...
  vim.api.nvim_set_hl(0, "RenderMarkdownHint", { fg = p.rosa }) -- importante
